...
class mock_unit:
	...
	key = "mock_test"
	key_int = 12
	key_more_than_32 = "Freshwork Assignment by Abhinav Shukla"
   ...
   "products":{ 
	...
	value_json_type = { "employee":"Abhinav", "status":"fresher", "role":"software_engineer" }
	value_string = "Bangalore, Chennai and Delhi"
	ttl_value = 10
